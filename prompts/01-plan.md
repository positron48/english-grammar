...
- **question_types_needed**: Выбраны только те типы вопросов, которые логично проверяют материал главы. НЕ включай все типы "для количества" - выбирай только подходящие.